        ...
        <div className="content-grid">
          <section id="home" className="scroll-mt-28">
            <CardShell className="hero-panel">
              <div className="panel-scroll-indicator" />
              <PanelRail activeSection={activeSection} compact />
          ...
          <div className="dashboard-grid">
            <section id="skills" className="scroll-mt-28">
              <CardShell className="dashboard-card">
                <div className="panel-scroll-indicator" />
                <PanelRail activeSection={activeSection} compact />
                ...
                <div className="dashboard-content">
                  <SectionHeading
                    title="My Skills"
                    description="A polished mix of frontend tooling and interface thinking, shown with compact cards and glowing progress bars."
                  />

                  <div className="mini-skill-grid">
                    {skillCards.map(({ title, subtitle, icon: Icon, accent }) => (
                      <div key={title} className="mini-skill-card">
                        <span className={`mini-skill-icon mini-skill-icon-${accent}`}>
            ...
            <section id="projects" className="scroll-mt-28">
              <CardShell className="dashboard-card">
                ...
                <div className="dashboard-content">
                  <SectionHeading
                    title="My Portfolio"
                    description="A collection of personal and client-facing concepts presented in the same sleek dashboard language."
                  />
            ...
            <section id="education" className="scroll-mt-28">
              <CardShell className="dashboard-card">
                ...
                <div className="dashboard-content">
                  <SectionHeading
                    title="Education"
                    description="My learning path combines academic study, frontend building practice, and hands-on UI exploration."
                  />
              ...
              <CardShell className="dashboard-card">
                ...
                <div className="dashboard-content">
                  <SectionHeading
                    ...
                    description="Communication, reachability, and collaboration details kept inside the same visual system."
                  />
            ...
            <CardShell className="footer-panel">
              <div className="footer-copy">
                <p className="panel-copy">
                  Designed for Jasmeet with a modern dark portfolio style inspired by the
                  reference layout.
                </p>
                <div className="footer-socials">
                  {socialLinks.map(({ label, href, icon: Icon }) => (
                    <a key={label} href={href} aria-label={label} className="social-chip">
                      <Icon className="h-4 w-4" />
                    </a>
                  ))}
                </div>
              ...
              <div className="footer-links">
                ...
                <a href="#home" className="cta-secondary">
                  Back to Top
                  <ArrowRight className="h-4 w-4" />
                </a>
              </div>
